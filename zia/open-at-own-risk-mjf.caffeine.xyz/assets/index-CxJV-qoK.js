...
const Fireworks = () => {
  ...
  reactExports.useEffect(() => {
    ...
    const particles = [];
    const colors = ["#ff1744", "#f50057", "#ff4081", "#ff80ab", "#ff5252", "#ff6e40"];
    ...
    setTimeout(() => createFirework(canvas.width / 3, canvas.height / 4), 200);
    setTimeout(() => createFirework(canvas.width * 2 / 3, canvas.height / 4), 400);
    const animate = () => {
...
const CelebrationScene = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-hidden bg-gradient-to-br from-pink-200 via-rose-200 to-red-200 dark:from-pink-900 dark:via-rose-900 dark:to-red-900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 bg-cover bg-center opacity-30",
        style: { backgroundImage: "url(/assets/generated/romantic-background.dim_1200x800.png)" }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [...Array(30)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex flex-col items-center justify-center min-h-screen p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-8 max-w-4xl mx-auto animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-16 h-16 text-red-500 animate-pulse", fill: "currentColor" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-6xl md:text-8xl font-bold bg-gradient-to-r from-pink-600 via-red-500 to-rose-600 bg-clip-text text-transparent", children: "Yay! 🎉" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-16 h-16 text-red-500 animate-pulse", fill: "currentColor" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-bold text-rose-700 dark:text-rose-300 leading-tight", children: "I knew you'd say yes! 💕" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-12 animate-scale-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-pink-400 to-rose-400 rounded-3xl blur-2xl opacity-50 animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-fade-in-delay", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl md:text-4xl font-bold text-rose-600 dark:text-rose-400", children: "You've made me the happiest! 💖" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl text-rose-500 dark:text-rose-300 italic", children: `"This Valentine's Day is going to be magical with you by my side..."` })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-4 mt-8", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Heart,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "absolute bottom-4 left-0 right-0 text-center text-sm text-rose-600/70 dark:text-rose-400/70 z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center justify-center gap-2", children: [
      "© 2025. Built with ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-4 h-4 inline animate-pulse", fill: "currentColor" }),
      " using",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://caffeine.ai", target: "_blank", rel: "noopener noreferrer", className: "hover:text-rose-700 dark:hover:text-rose-300 underline", children: "caffeine.ai" })
    ] }) })
  ] });
};
function App() {
  const [appState, setAppState] = reactExports.useState("question");
  const [noButtonPosition, setNoButtonPosition] = reactExports.useState(null);
  const [hoverMessage, setHoverMessage] = reactExports.useState("");
  const [hoverCount, setHoverCount] = reactExports.useState(0);
  const [noButtonText, setNoButtonText] = reactExports.useState("No");
  const [messageIndex, setMessageIndex] = reactExports.useState(0);
  const noButtonRef = reactExports.useRef(null);
  const yesButtonRef = reactExports.useRef(null);
  ...
  const moveNoButton = (updateMessage = false) => {
    ...
    do {
      ...
      if (yesButtonRef.current) {
        ...
        const noButtonWidth = button.width;
        const noButtonHeight = button.height;
        const margin = 20;
        const overlaps = !(newX + noButtonWidth + margin < yesButton.left || newX - margin > yesButton.right || newY + noButtonHeight + margin < yesButton.top || newY - margin > yesButton.bottom);
        if (!overlaps) break;
      } else {
        break;
      }
    ...
    if (updateMessage) {
      const newMessage = sarcasticMessages[messageIndex % sarcasticMessages.length];
      setNoButtonText(newMessage);
      setMessageIndex((prev) => prev + 1);
    } else {
      const messageIdx = hoverCount % playfulMessages.length;
      setHoverMessage(playfulMessages[messageIdx]);
      setHoverCount((prev) => prev + 1);
      setTimeout(() => setHoverMessage(""), 2e3);
    }
  };
  const handleMouseMove = (e) => {
    if (!noButtonRef.current || appState !== "question" || noButtonPosition !== null) return;
    const button = noButtonRef.current.getBoundingClientRect();
  ...
  const handleYesClick = () => {
    setAppState("fireworks");
  };
  if (appState === "celebration") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CelebrationScene, {});
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "relative min-h-screen overflow-hidden bg-gradient-to-br from-pink-100 via-rose-100 to-red-100 dark:from-pink-950 dark:via-rose-950 dark:to-red-950",
      onMouseMove: handleMouseMove,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [...Array(15)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Heart,
          {
            className: "absolute text-pink-300/30 dark:text-pink-700/30 animate-float",
            style: {
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
        ...
        appState === "fireworks" && /* @__PURE__ */ jsxRuntimeExports.jsx(Fireworks, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ref: containerRef,
            className: "relative z-10 flex flex-col items-center justify-center min-h-screen p-8",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-8 max-w-2xl mx-auto", children: [
              ...
              hoverMessage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-bounce-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-semibold text-pink-600 dark:text-pink-400 bg-white/80 dark:bg-gray-900/80 rounded-full px-6 py-3 shadow-lg inline-block", children: hoverMessage }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-32 mt-12", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: yesButtonRef, className: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -ml-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    onClick: handleYesClick,
                    size: "lg",
                    className: "text-2xl px-12 py-8 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-bold rounded-full shadow-2xl transform hover:scale-110 transition-all duration-300 border-4 border-white dark:border-pink-900",
                    children: "Yes! 💕"
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    variant: "outline",
                    size: "lg",
                    className: `text-2xl px-12 py-8 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-bold rounded-full shadow-xl border-4 border-gray-300 dark:border-gray-600 z-30 ${noButtonPosition === null ? "absolute left-1/2 top-1/2 -translate-y-1/2 ml-8" : "fixed"}`,
                    style: noButtonPosition !== null ? {
                      left: `${noButtonPosition.x}px`,
                      top: `${noButtonPosition.y}px`,
                      transition: "left 0.5s ease-in-out, top 0.5s ease-in-out"
                    } : void 0,
                    children: noButtonText
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 animate-fade-in-delay", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl text-rose-600 dark:text-rose-400 font-medium italic", children: '"Every moment with you feels like a dream come true..."' }) })
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "absolute bottom-4 left-0 right-0 text-center text-sm text-rose-500/70 dark:text-rose-400/70 z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center justify-center gap-2", children: [
          "© 2025. Built with ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-4 h-4 inline animate-pulse", fill: "currentColor" }),
          " using",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://caffeine.ai", target: "_blank", rel: "noopener noreferrer", className: "hover:text-rose-600 dark:hover:text-rose-300 underline", children: "caffeine.ai" })
        ] }) })
      ]
    }
  );
